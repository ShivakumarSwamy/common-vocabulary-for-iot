package de.uni.stuttgart.ipvs.um.auth.token;
...
import static de.uni.stuttgart.ipvs.um.auth.AuthConstants.HEADER_NAME_AUTHORIZATION;
import static de.uni.stuttgart.ipvs.um.auth.AuthConstants.JWT_TOKEN_PREFIX;
